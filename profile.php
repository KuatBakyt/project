								...
								if ($_SESSION['nickname'] == $_GET['nickname']) {
									...
									<span class="link">
										...
										<ul class="dropdown">
											...
											<li><a href="<?= $BASE_URL ?>/api/blog/delete.php?id=<?= $blog['id'] ?>"
													class="danger">Удалить</a></li>
										</ul>
									</span>
								<?php
								}
		...
		<div class="page-info">
			<div class="user-profile">
				...
				<?php
					...
					?>
					<img class="user-profile--ava" src="images/incognito.jpg" alt="">
				<?php
				}
				?>
				<h1>
				...
				<p>
					<?= mysqli_num_rows($blogs) ?> постов за все время
				</p>
				<a href="<?= $BASE_URL ?>/editProfile.php?id=<?= $_SESSION['id'] ?>" class="button">Редактировать</a>
				<a href="<?= $BASE_URL ?>/api/user/signout.php" class="button button-danger"> Выход</a>
				<a href="<?= $BASE_URL ?>/api/user/delete.php.php" class="button button-danger"> Удалить аккаунт</a>
			</div>
		</div>
	</section>
</body>
